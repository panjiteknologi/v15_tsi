{
    ...
    "price": 99,
    "currency": "USD",
    "summary": "Meta Whatsapp chat all in one integrated with the sale purchase accounting discuss modules. all in one whatsapp can help you to take the advantage of the whatsapp communication in "
    "current market",
    "description": """
The WhatsApp Business Platform Cloud API is based on Meta/Facebook's Graph API Which allows medium and large businesses to communicate with their customers at scale. Send and receive whatsapp
messages quickly & easily directly from Odoo to WhatsApp and WhatsApp to Odoo.
