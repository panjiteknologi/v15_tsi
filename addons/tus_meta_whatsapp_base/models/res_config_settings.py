...
class ResConfigSettings(models.TransientModel):
    ...
    module_tus_meta_wa_helpdesk_in_discuss = fields.Boolean(
        "Tus Whatsapp Helpdesk In Discuss"
    )
    module_tus_meta_wa_helpdesk = fields.Boolean("Tus Whatsapp Helpdesk")
    module_tus_meta_wa_follow_up_report = fields.Boolean(
        "Tus Whatsapp Follow Up Report"
    )
    ...
    module_tus_meta_wa_invoice_in_discuss = fields.Boolean(
        "Tus Whatsapp Invoice In Discuss"
    )
    module_tus_meta_wa_marketing = fields.Boolean("Tus Whatsapp Marketing")
    module_tus_meta_wa_purchase_in_discuss = fields.Boolean(
        "Tus Whatsapp Purchase In Discuss"
    )
        ...
        modules = ModuleSudo.search(
            [
                (
                    "name",
                    "=",
                    "module_tus_meta_wa_purchase_in_discuss".replace("module_", ""),
                )
            ]
        )
        if not modules and self.module_tus_meta_wa_purchase_in_discuss:
            return {
                "warning": {
                    "title": _("Warning!"),
                    "message": _(
                        "Tus Whatsapp Purchase In Discuss In Discuss module not exist!"
                    ),
                }
            }
        ...
        modules = ModuleSudo.search(
            [
                (
                    "name",
                    "=",
                    "module_tus_meta_wa_invoice_in_discuss".replace("module_", ""),
                )
            ]
        )
        ...
        modules = ModuleSudo.search(
            [
                (
                    "name",
                    "=",
                    "module_tus_meta_wa_helpdesk_in_discuss".replace("module_", ""),
                )
            ]
        )
        ...
        modules = ModuleSudo.search(
            [
                (
                    "name",
                    "=",
                    "module_tus_meta_wa_follow_up_report".replace("module_", ""),
                )
            ]
        )
