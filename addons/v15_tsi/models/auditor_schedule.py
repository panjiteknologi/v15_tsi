...
class AuditorSchedule(models.Model):
    _name = "tsi.auditor_schedule"
    _description = "Auditor Schedule"
    _order = 'id DESC'
    
    nama = fields.Char(string='Nama')
            
    def action_open_auditor_schedule(self):
        base_url = "https://scheduler-audit.vercel.app"
