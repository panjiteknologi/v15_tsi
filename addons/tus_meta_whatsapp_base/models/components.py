...
class Components(models.Model):
    ...
    formate = fields.Selection(
        [("text", "TEXT"), ("media", "MEDIA")], "Formate", default="text"
    )
    formate_media_type = fields.Selection(
        [("static", "Static Media File"), ("dynamic", "Dynamic Media File")],
    ...
    type_of_action = fields.Selection(
        [("PHONE_NUMBER", "Call Phone Number"), ("URL", "Visit Website")],
        "Type of Action",
    ...
    url_type = fields.Selection(
        [("static", "Static"), ("dynamic", "Dynamic")], "URL Type", default="static"
    )
    url_type_2 = fields.Selection(
        [("static", "Static"), ("dynamic", "Dynamic")], "URL type", default="static"
    )
    ...
    quick_reply_type = fields.Selection(
        [("custom", "Custom")], string="Quick Reply Type", default="custom"
    )
    quick_reply_type_2 = fields.Selection(
        [("custom", "Custom")], string="Quick Reply type", default="custom"
    )
    quick_reply_type_3 = fields.Selection(
        [("custom", "Custom")], string="Quick reply type", default="custom"
    )
    footer_text = fields.Char(
        string="Footer Text", default="Not interested? Tap Stop promotions"
    )
    type_of_action_2 = fields.Selection(
        [("PHONE_NUMBER", "Call Phone Number"), ("URL", "Visit Website")],
        "Type of action",
        default="URL",
    )
